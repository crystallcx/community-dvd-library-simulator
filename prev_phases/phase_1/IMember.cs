...
using System.Text;
    ...
    interface IMember
    {
        ...
        if (phonenumber == null || phonenumber.Length != 10 || phonenumber[0] != '0')
        {
            Console.WriteLine("Not a valid phone number, incorrect format.");
            return false;
        }
        ...
        {
            Console.WriteLine("Not a valid pin number, incorrect format.");
            return false; //pin not valid.
        }
        ...
        foreach (char c in pin)
        {
            if (c > '9' || c < '0')
            {
                Console.WriteLine("Not a valid pin number.");
                return false; //pin not valid.
            }
        }
        return true;
